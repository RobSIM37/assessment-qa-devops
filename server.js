...
var rollbar = new Rollbar({
  accessToken: '394778042fc84ca4b43ceab2073b2475',
...
app.get('/favicon.ico', (req, res) => {
    try {
        res.status(200).sendFile(path.join(__dirname, "iconImage.ico"));
    } catch (error) {
        rollbar.error("ERROR GETTING ICON")
        res.sendStatus(400)
    }
});
